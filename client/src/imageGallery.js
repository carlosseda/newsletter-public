...
class ImageGallery extends HTMLElement {
    ...
    constructor() {
        ...
        this.openGalleryHandler = event => {
            this.openGallery(event.detail.image);
        }

        this.closeGalleryHandler = event => {
            if (this.shadow.querySelector('.modal').classList.contains('active')) {
                this.shadow.querySelector('.modal').classList.remove('active');
            }
        }

        document.addEventListener("openGallery", this.openGalleryHandler);
        document.addEventListener("hideOverlayer", this.closeGalleryHandler);
    }
    ...
    async openGallery(image) {
        ...
        let imageElement = this.shadow.querySelector(`.image[data-filename="${image.filename}"]`);
